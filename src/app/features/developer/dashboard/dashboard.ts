...
import { DeveloperDashboardStats } from '../../../core/tickets/models';
...
const CARDS: StatCard[] = [
  { label: 'Total Assigned', value: (s) => s.totalAssigned, accent: 'bg-slate-100 text-slate-700' },
  ...
  template: `
    ...
    @if (loading()) {
      ...
      <div class="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div class="rounded-lg border-2 border-red-200 bg-red-50 p-5">
        ...
        <div class="rounded-lg border-2 border-orange-200 bg-orange-50 p-5">
          <div class="flex items-center justify-between">
