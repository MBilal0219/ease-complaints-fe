...
const SALES_PERSON_NAV_ITEMS: NavItem[] = [
  {
    label: 'Dashboard',
    route: '/app/sales-person/dashboard',
  ...
  {
    label: 'Settings',
    route: '/app/sales-person/settings',
